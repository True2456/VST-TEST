...
# By default, that is three directories up from /Examples/MyPermissivePlugin/config
IPLUG2_ROOT = ../../dependencies/iplug2

include ../../dependencies/iplug2/common-wasm.mk

SRC += $(PROJECT_ROOT)/MyPermissivePlugin.cpp
